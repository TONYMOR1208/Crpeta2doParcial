...
exports.NewMigrationName1719705788270 = void 0;
class NewMigrationName1719705788270 {
    constructor() {
        this.name = 'NewMigrationName1719705788270';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "palabra" ("id" SERIAL NOT NULL, "palabra" character varying NOT NULL, "deletreo" character varying NOT NULL, "silabas" integer NOT NULL, "fonetica" character varying NOT NULL, "estado" text NOT NULL, CONSTRAINT "PK_0c390f1d824c5162142a553166f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "registro" ("id" SERIAL NOT NULL, "deletreo" character varying NOT NULL, "silabas" integer NOT NULL, "fonetica" character varying NOT NULL, "estado" text NOT NULL, "idiomaId" integer, "palabraId" integer, CONSTRAINT "PK_68115a72117fce58864e9bf6509" PRIMARY KEY ("id"))`);
...
exports.NewMigrationName1719705788270 = NewMigrationName1719705788270;
//# sourceMappingURL=1719705788270-NewMigrationName.js.map